...
form.addEventListener("submit", function (e) {
    ...
    const taskDueDate = form.dataset.value;
...
function deleteTask() {
    ...
    tasks.todo.push(taskObj); //Pushing the new task into the task object.
...
function editTask(e) {
    ...
    form.dataset.value = currentElement.dueDate;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (extractedData) {
        ...
        function createTask(id, taskName, taskDueDate, taskPriority, key, i) {
            ...
            newTask.innerHTML = `<div class="header">
                                 <p> Due on ${taskDueDate}</p>
                                 <p classs="priority" style="color:${applyColor(
                                    taskPriority.trim()
                                 )}">${taskPriority}</p>
                                 </div>
                                 <div> 
        ...
        filter.addEventListener("change", () => {
            ...
            if (filter.value === "All") {
                ...
                for(let key in tasks) {
                    tasks[key].forEach((item) => {
                        if (item.priority === filter.value, item.priority, key, i);
                    });
                    i++;
                    }
                });
